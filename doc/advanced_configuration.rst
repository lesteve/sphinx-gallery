...
.. note:: The deprecated parameter ``find_mayavi_figures``

You can also add your own custom function (or callable class instance)
to this list. It needs to take two parameters (filename for formatting
and offset number), write out the proper PNG files, and return the number
...
current directory could do, e.g.::
    ...
    class PNGScraper(object):
        ...
        def __call__(self, image_path, offset, gallery_conf):
            count = 0
